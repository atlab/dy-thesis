\begin{figure}
\begin{leftfullpage}
\caption[Example of sparse partial correlation structure]{
{\bf Example of sparse partial correlation structure revealed by $C_{\sf sparse+latent}$.}
...
\begin{fullpage}
        \begin{center}
        \includegraphics[height=\textwidth]{./figures/Figure5.png}
        \end{center}
\end{fullpage}
\end{figure}
